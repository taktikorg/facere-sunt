# @taktikorg/facere-sunt

<a href="https://www.npmjs.com/package/@taktikorg/facere-sunt"><img alt="npm version" src="https://badge.fury.io/js/@taktikorg/facere-sunt.svg"></a>
<a href="https://npmjs.org/package/@taktikorg/facere-sunt"><img alt="Downloads" src="http://img.shields.io/npm/dm/@taktikorg/facere-sunt.svg"></a>
[![Build Status](https://travis-ci.org/mosch/@taktikorg/facere-sunt.svg?branch=master)](https://travis-ci.org/mosch/@taktikorg/facere-sunt)
[![Design](https://contribute.design/api/shield/mosch/@taktikorg/facere-sunt)](https://contribute.design/mosch/@taktikorg/facere-sunt)
...
Just use your favorite package manager to add `@taktikorg/facere-sunt` to your project:

```sh
yarn add @taktikorg/facere-sunt

npm i --save @taktikorg/facere-sunt

pnpm add @taktikorg/facere-sunt
```

## [Demo](https://@taktikorg/facere-sunt.netlify.com/)
...
import AvatarEditor from '@taktikorg/facere-sunt'
...
drag and drop support to anything really easy. Here is an example how to use it with @taktikorg/facere-sunt:
